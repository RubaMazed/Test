...
namespace BioMetrixCore
{
    public class ZkemClient : CZKEM
    {
        ...
        public bool GetBellSchDataEx(int dwMachineNumber, int weekDay, int Index, out int Enable, out int Hour, out int min,
            out int voice, out int way, out int InerBellDelay, out int ExtBellDelay)
        {
            throw new NotImplementedException();
        }
        ...
        public bool GetEachBellInfo(int dwMachineNumber, out int weekDay, out int Index, out int Enable, out int Hour, out int min,
            out int voice, out int way, out int InerBellDelay, out int ExtBellDelay)
        {
            throw new NotImplementedException();
        }
        ...
        public bool GetUserValidDate(int dwMachineNumber, string UserID, out int Expires, out int ValidCount, out string StartDate,
            out string EndDate)
        {
            throw new NotImplementedException();
        }
        ...
        public bool SSR_GetGeneralLogDataEx(int dwMachineNumber, out string dwEnrollNumber, out int dwVerifyMode, out int dwInOutMode,
            out int dwYear, out int dwMonth, out int dwDay, out int dwHour, out int dwMinute, out int dwSecond,
            out string dwWorkCode)
        {
            throw new NotImplementedException();
        }
        ...
        public bool GetAllSFIDName(int dwMachineNumber, out string ShortkeyIDName, int BufferSize1, out string FunctionIDName,
            int BufferSize2)
        {
            throw new NotImplementedException();
        }
        ...
        public event _IZKEMEvents_OnConnectedEventHandler OnConnected;
        public event _IZKEMEvents_OnDisConnectedEventHandler OnDisConnected;
        public event _IZKEMEvents_OnFingerEventHandler OnFinger;
        ...
        public event _IZKEMEvents_OnGeneralEventEventHandler OnGeneralEvent;
        public event _IZKEMEvents_OnAttTransactionEx_NewEventHandler OnAttTransactionEx_New;
    }
}
